...
#define DECODE_D3D10_SB_TOKENIZED_PROGRAM_TYPE(VerTok)                                  \
  ((D3D10_SB_TOKENIZED_PROGRAM_TYPE)(((VerTok)&D3D10_SB_TOKENIZED_PROGRAM_TYPE_MASK) >> \
...
#define DECODE_D3D10_SB_TOKENIZED_PROGRAM_MAJOR_VERSION(VerTok)                \
...
#define DECODE_D3D10_SB_TOKENIZED_PROGRAM_MINOR_VERSION(VerTok)                \
  ((VerTok)&D3D10_SB_TOKENIZED_PROGRAM_MINOR_VERSION_MASK)

// ENCODER MACRO: Create complete VerTok
#define ENCODE_D3D10_SB_TOKENIZED_PROGRAM_VERSION_TOKEN(ProgType, MajorVer,    \
                                                        MinorVer)              \
  ((((ProgType) << D3D10_SB_TOKENIZED_PROGRAM_TYPE_SHIFT) &                    \
...
typedef enum D3D10_SB_OPCODE_TYPE {
  ...
  D3D11_SB_OPCODE_HS_CONTROL_POINT_PHASE, // token marks beginning of HS
                                          // sub-shader
...
// The range is 1-127.
#define DECODE_D3D10_SB_TOKENIZED_INSTRUCTION_LENGTH(OpcodeToken0)             \
...
#define ENCODE_D3D10_SB_TOKENIZED_INSTRUCTION_LENGTH(Length)                   \
...
#define DECODE_IS_D3D10_SB_INSTRUCTION_SATURATE_ENABLED(OpcodeToken0)          \
  ((OpcodeToken0)&D3D10_SB_INSTRUCTION_SATURATE_MASK)
// ENCODER MACRO: Encode in OpcodeToken0 if instruction is to saturate the
// result.
#define ENCODE_D3D10_SB_INSTRUCTION_SATURATE(bSat)                             \
  (((bSat) != 0) ? D3D10_SB_INSTRUCTION_SATURATE_MASK : 0)
...
#define DECODE_D3D10_SB_INSTRUCTION_TEST_BOOLEAN(OpcodeToken0)                                    \
  ((D3D10_SB_INSTRUCTION_TEST_BOOLEAN)(((OpcodeToken0)&D3D10_SB_INSTRUCTION_TEST_BOOLEAN_MASK) >> \
...
#define ENCODE_D3D10_SB_INSTRUCTION_TEST_BOOLEAN(Boolean)                      \
  (((Boolean) << D3D10_SB_INSTRUCTION_TEST_BOOLEAN_SHIFT) &                    \
...
#define DECODE_D3D11_SB_INSTRUCTION_PRECISE_VALUES(OpcodeToken0)               \
...
#define ENCODE_D3D11_SB_INSTRUCTION_PRECISE_VALUES(ComponentMask)              \
...
#define DECODE_D3D10_SB_RESINFO_INSTRUCTION_RETURN_TYPE(OpcodeToken0)                                           \
  ((D3D10_SB_RESINFO_INSTRUCTION_RETURN_TYPE)(((OpcodeToken0)&D3D10_SB_RESINFO_INSTRUCTION_RETURN_TYPE_MASK) >> \
...
#define ENCODE_D3D10_SB_RESINFO_INSTRUCTION_RETURN_TYPE(ReturnType)            \
...
#define DECODE_D3D11_SB_SYNC_FLAGS(OperandToken0)                              \
  ((OperandToken0)&D3D11_SB_SYNC_FLAGS_MASK)

// ENCODER MACRO: Given a set of sync instruciton flags, encode them in
// OpcodeToken0.
...
// extended opcodes.
#define DECODE_IS_D3D10_SB_OPCODE_EXTENDED(OpcodeToken0)                       \
  (((OpcodeToken0)&D3D10_SB_OPCODE_EXTENDED_MASK) >>                           \
...
#define ENCODE_D3D10_SB_OPCODE_EXTENDED(bExtended)                             \
  (((bExtended) != 0) ? D3D10_SB_OPCODE_EXTENDED_MASK : 0)
...
//              [22:11] When dimension is
//              D3D11_SB_RESOURCE_DIMENSION_STRUCTURED_BUFFER this holds the
//              buffer stride, otherwise 0 [30:23] Ignored, 0.
//         }
...
//         of extended opcode tokens can be chained.  It is possible that some
//         extended opcode tokens could include multiple DWORDS - that is
...
#define DECODE_D3D10_SB_EXTENDED_OPCODE_TYPE(OpcodeToken1)                     \
  ((D3D10_SB_EXTENDED_OPCODE_TYPE)((                                           \
      OpcodeToken1)&D3D10_SB_EXTENDED_OPCODE_TYPE_MASK))

// ENCODER MACRO: Store extended opcode token
// type in OpcodeToken1.
#define ENCODE_D3D10_SB_EXTENDED_OPCODE_TYPE(ExtOpcodeType)                    \
...
#define D3D10_SB_IMMEDIATE_ADDRESS_OFFSET_SHIFT(Coord)                         \
  (9 + 4 * ((Coord)&D3D10_SB_IMMEDIATE_ADDRESS_OFFSET_COORD_MASK))
#define D3D10_SB_IMMEDIATE_ADDRESS_OFFSET_MASK(Coord)                          \
...
#define DECODE_IMMEDIATE_D3D10_SB_ADDRESS_OFFSET(Coord, OpcodeToken1)          \
...
// type == D3D10_SB_EXTENDED_OPCODE_SAMPLE_CONTROLS (opcode type encoded
// separately) A 2's complement number is expected as input, from which the LSB
// 4 bits are extracted.
#define ENCODE_IMMEDIATE_D3D10_SB_ADDRESS_OFFSET(Coord, ImmediateOffset)       \
...
#define DECODE_D3D11_SB_EXTENDED_RESOURCE_DIMENSION(OpcodeTokenN)                              \
  ((D3D10_SB_RESOURCE_DIMENSION)(((OpcodeTokenN)&D3D11_SB_EXTENDED_RESOURCE_DIMENSION_MASK) >> \
                                 D3D11_SB_EXTENDED_RESOURCE_DIMENSION_SHIFT))

// ENCODER MACRO: Store resource dimension
// (D3D10_SB_RESOURCE_DIMENSION enum) into a
// an extended resource declaration token
// (D3D11_SB_EXTENDED_OPCODE_RESOURCE_DIM)
#define ENCODE_D3D11_SB_EXTENDED_RESOURCE_DIMENSION(ResourceDim)               \
...
// DECODER MACRO: Given an extended resource declaration token for a structured
// buffer, (D3D11_SB_EXTENDED_OPCODE_RESOURCE_DIM), determine the structure
// stride (12-bit unsigned integer)
#define DECODE_D3D11_SB_EXTENDED_RESOURCE_DIMENSION_STRUCTURE_STRIDE(             \
    OpcodeTokenN)                                                                 \
...
// an extended resource declaration token
// (D3D11_SB_EXTENDED_OPCODE_RESOURCE_DIM)
#define ENCODE_D3D11_SB_EXTENDED_RESOURCE_DIMENSION_STRUCTURE_STRIDE(Stride)   \
...
#define DECODE_D3D10_SB_CUSTOMDATA_CLASS(CustomDataDescTok)                            \
  ((D3D10_SB_CUSTOMDATA_CLASS)(((CustomDataDescTok)&D3D10_SB_CUSTOMDATA_CLASS_MASK) >> \
                               D3D10_SB_CUSTOMDATA_CLASS_SHIFT))
// ENCODER MACRO: Create complete CustomDataDescTok
#define ENCODE_D3D10_SB_CUSTOMDATA_CLASS(CustomDataClass)                      \
  (ENCODE_D3D10_SB_OPCODE_TYPE(D3D10_SB_OPCODE_CUSTOMDATA) |                   \
   (((CustomDataClass) << D3D10_SB_CUSTOMDATA_CLASS_SHIFT) &                   \
...
#define DECODE_D3D10_SB_OPERAND_NUM_COMPONENTS(OperandToken0)                  \
  ((D3D10_SB_OPERAND_NUM_COMPONENTS)((                                         \
      OperandToken0)&D3D10_SB_OPERAND_NUM_COMPONENTS_MASK))

// ENCODER MACRO: Define in OperandToken0 how many components
// the data vector referred to by the operand contains.
// (D3D10_SB_OPERAND_NUM_COMPONENTS enum).
#define ENCODE_D3D10_SB_OPERAND_NUM_COMPONENTS(NumComp)                        \
...
#define DECODE_D3D10_SB_OPERAND_4_COMPONENT_SELECTION_MODE(OperandToken0)                                              \
  ((D3D10_SB_OPERAND_4_COMPONENT_SELECTION_MODE)(((OperandToken0)&D3D10_SB_OPERAND_4_COMPONENT_SELECTION_MODE_MASK) >> \
                                                 D3D10_SB_OPERAND_4_COMPONENT_SELECTION_MODE_SHIFT))

// ENCODER MACRO: For an operand representing 4component data,
// encode in OperandToken0 a value from
// D3D10_SB_OPERAND_4_COMPONENT_SELECTION_MODE
#define ENCODE_D3D10_SB_OPERAND_4_COMPONENT_SELECTION_MODE(SelectionMode)      \
...
#define DECODE_D3D10_SB_OPERAND_4_COMPONENT_MASK(OperandToken0)                \
...
#define ENCODE_D3D10_SB_OPERAND_4_COMPONENT_MASK(ComponentMask)                \
...
#define D3D10_SB_OPERAND_4_COMPONENT_MASK(ComponentName)                       \
...
// as a field of D3D10_SB_OPERAND_4_COMPONENT_MASK_[X|Y|Z|W] flags.
#define DECODE_D3D10_SB_OPERAND_4_COMPONENT_SWIZZLE(OperandToken0)             \
...
#define DECODE_D3D10_SB_OPERAND_4_COMPONENT_SWIZZLE_SOURCE(OperandToken0,            \
                                                           DestComp)                 \
  ((D3D10_SB_4_COMPONENT_NAME)(((OperandToken0) >>                                   \
...
#define D3D10_SB_OPERAND_4_COMPONENT_NOSWIZZLE                                 \
...
#define D3D10_SB_OPERAND_4_COMPONENT_REPLICATEX                                \
  ENCODE_D3D10_SB_OPERAND_4_COMPONENT_SWIZZLE(                                 \
      D3D10_SB_4_COMPONENT_X, D3D10_SB_4_COMPONENT_X, D3D10_SB_4_COMPONENT_X,  \
      D3D10_SB_4_COMPONENT_X)

#define D3D10_SB_OPERAND_4_COMPONENT_REPLICATEY                                \
  ENCODE_D3D10_SB_OPERAND_4_COMPONENT_SWIZZLE(                                 \
      D3D10_SB_4_COMPONENT_Y, D3D10_SB_4_COMPONENT_Y, D3D10_SB_4_COMPONENT_Y,  \
      D3D10_SB_4_COMPONENT_Y)

#define D3D10_SB_OPERAND_4_COMPONENT_REPLICATEZ                                \
  ENCODE_D3D10_SB_OPERAND_4_COMPONENT_SWIZZLE(                                 \
      D3D10_SB_4_COMPONENT_Z, D3D10_SB_4_COMPONENT_Z, D3D10_SB_4_COMPONENT_Z,  \
      D3D10_SB_4_COMPONENT_Z)

#define D3D10_SB_OPERAND_4_COMPONENT_REPLICATEW                                \
  ENCODE_D3D10_SB_OPERAND_4_COMPONENT_SWIZZLE(                                 \
      D3D10_SB_4_COMPONENT_W, D3D10_SB_4_COMPONENT_W, D3D10_SB_4_COMPONENT_W,  \
      D3D10_SB_4_COMPONENT_W)

#define D3D10_SB_OPERAND_4_COMPONENT_REPLICATERED                              \
  D3D10_SB_OPERAND_4_COMPONENT_REPLICATEX
#define D3D10_SB_OPERAND_4_COMPONENT_REPLICATEGREEN                            \
  D3D10_SB_OPERAND_4_COMPONENT_REPLICATEY
#define D3D10_SB_OPERAND_4_COMPONENT_REPLICATEBLUE                             \
  D3D10_SB_OPERAND_4_COMPONENT_REPLICATEZ
#define D3D10_SB_OPERAND_4_COMPONENT_REPLICATEALPHA                            \
...
#define DECODE_D3D10_SB_OPERAND_4_COMPONENT_SELECT_1(OperandToken0)                            \
  ((D3D10_SB_4_COMPONENT_NAME)(((OperandToken0)&D3D10_SB_OPERAND_4_COMPONENT_SELECT_1_MASK) >> \
...
#define ENCODE_D3D10_SB_OPERAND_4_COMPONENT_SELECT_1(SelectedComp)             \
...
typedef enum D3D10_SB_OPERAND_TYPE {
  ...
  D3D10_SB_OPERAND_TYPE_INDEXABLE_TEMP =
      3, // Temporary Register File (indexable)
  D3D10_SB_OPERAND_TYPE_IMMEDIATE32 =
      4, // 32bit/component immediate value(s)
  ...
  D3D10_SB_OPERAND_TYPE_NULL =
      13, // Null register, used to discard results of operations
          // Below Are operands new in DX 10.1
  D3D10_SB_OPERAND_TYPE_RASTERIZER =
      14, // DX10.1 Rasterizer register, used to denote the depth/stencil and
          // render target resources
  D3D10_SB_OPERAND_TYPE_OUTPUT_COVERAGE_MASK =
      15, // DX10.1 PS output MSAA coverage mask (scalar)
  ...
  D3D11_SB_OPERAND_TYPE_FUNCTION_BODY =
      17, // Reference to a function definition
  D3D11_SB_OPERAND_TYPE_FUNCTION_TABLE =
      18, // Reference to a set of functions used by a class
  D3D11_SB_OPERAND_TYPE_INTERFACE = 19, // Reference to an interface
  D3D11_SB_OPERAND_TYPE_FUNCTION_INPUT =
      20, // Reference to an input parameter to a function
  D3D11_SB_OPERAND_TYPE_FUNCTION_OUTPUT =
      21, // Reference to an output parameter to a function
  D3D11_SB_OPERAND_TYPE_OUTPUT_CONTROL_POINT_ID =
      22, // HS Control Point phase input saying which output control point ID
          // this is
  D3D11_SB_OPERAND_TYPE_INPUT_FORK_INSTANCE_ID =
      23, // HS Fork Phase input instance ID
  D3D11_SB_OPERAND_TYPE_INPUT_JOIN_INSTANCE_ID =
      24, // HS Join Phase input instance ID
  ...
  D3D11_SB_OPERAND_TYPE_OUTPUT_STENCIL_REF =
      41, // DX11 PS output stencil reference (scalar)
  D3D11_SB_OPERAND_TYPE_INNER_COVERAGE =
      42, // DX11 PS input inner coverage (scalar)
...
#define DECODE_D3D10_SB_OPERAND_TYPE(OperandToken0)                            \
  ((D3D10_SB_OPERAND_TYPE)(((OperandToken0)&D3D10_SB_OPERAND_TYPE_MASK) >>     \
                           D3D10_SB_OPERAND_TYPE_SHIFT))

// ENCODER MACRO: Store operand type in OperandToken0.
#define ENCODE_D3D10_SB_OPERAND_TYPE(OperandType)                              \
...
#define DECODE_D3D10_SB_OPERAND_INDEX_DIMENSION(OperandToken0)                                   \
  ((D3D10_SB_OPERAND_INDEX_DIMENSION)(((OperandToken0)&D3D10_SB_OPERAND_INDEX_DIMENSION_MASK) >> \
...
#define ENCODE_D3D10_SB_OPERAND_INDEX_DIMENSION(OperandIndexDim)               \
...
#define D3D10_SB_OPERAND_INDEX_REPRESENTATION_MASK(Dim)                        \
...
// for index dimension [0], [1] or [2], depending on
// D3D10_SB_OPERAND_INDEX_DIMENSION.
#define DECODE_D3D10_SB_OPERAND_INDEX_REPRESENTATION(Dim, OperandToken0)                                \
  ((D3D10_SB_OPERAND_INDEX_REPRESENTATION)(((OperandToken0)&D3D10_SB_OPERAND_INDEX_REPRESENTATION_MASK( \
                                               Dim)) >>                                                 \
...
// for index dimension [0], [1] or [2], depending on
// D3D10_SB_OPERAND_INDEX_DIMENSION.
#define ENCODE_D3D10_SB_OPERAND_INDEX_REPRESENTATION(Dim, IndexRepresentation) \
  (((IndexRepresentation) << D3D10_SB_OPERAND_INDEX_REPRESENTATION_SHIFT(      \
        Dim)) &                                                                \
...
// by an additional opcode token.
#define DECODE_IS_D3D10_SB_OPERAND_EXTENDED(OperandToken0)                     \
  (((OperandToken0)&D3D10_SB_OPERAND_EXTENDED_MASK) >>                         \
...
#define ENCODE_D3D10_SB_OPERAND_EXTENDED(bExtended)                            \
  (((bExtended) != 0) ? D3D10_SB_OPERAND_EXTENDED_MASK : 0)
...
// to be able to interpret the rest of the token's contents.
#define DECODE_D3D10_SB_EXTENDED_OPERAND_TYPE(OperandToken1)                   \
  ((D3D10_SB_EXTENDED_OPERAND_TYPE)((                                          \
      OperandToken1)&D3D10_SB_EXTENDED_OPERAND_TYPE_MASK))

// ENCODER MACRO: Store extended operand token
// type in OperandToken1.
#define ENCODE_D3D10_SB_EXTENDED_OPERAND_TYPE(ExtOperandType)                  \
...
#define DECODE_D3D10_SB_OPERAND_MODIFIER(OperandToken1)                            \
  ((D3D10_SB_OPERAND_MODIFIER)(((OperandToken1)&D3D10_SB_OPERAND_MODIFIER_MASK) >> \
...
#define ENCODE_D3D10_SB_EXTENDED_OPERAND_MODIFIER(SourceMod)                   \
  ((((SourceMod) << D3D10_SB_OPERAND_MODIFIER_SHIFT) &                         \
...
typedef enum D3D11_SB_OPERAND_MIN_PRECISION {
  ...
  D3D11_SB_OPERAND_MIN_PRECISION_UINT_16 =
      5, // Min 16 bit/comp. unsigned integer
...
#define DECODE_D3D11_SB_OPERAND_MIN_PRECISION(OperandToken1)                                 \
...
#define ENCODE_D3D11_SB_OPERAND_MIN_PRECISION(MinPrecision)                    \
  (((MinPrecision) << D3D11_SB_OPERAND_MIN_PRECISION_SHIFT) &                  \
...
#define DECODE_D3D12_SB_OPERAND_NON_UNIFORM(OperandToken1)                     \
  (((OperandToken1)&D3D12_SB_OPERAND_NON_UNIFORM_MASK) >>                      \
   D3D12_SB_OPERAND_NON_UNIFORM_SHIFT)

// ENCODER MACRO: Encode non-uniform state into the extended operand token,
// OperandToken1
#define ENCODE_D3D12_SB_OPERAND_NON_UNIFORM(NonUniform)                        \
  (((NonUniform) << D3D12_SB_OPERAND_NON_UNIFORM_SHIFT) &                      \
   D3D12_SB_OPERAND_NON_UNIFORM_MASK)
...
#define DECODE_IS_D3D10_SB_OPERAND_DOUBLE_EXTENDED(OperandToken1)              \
...
// extended operand tokens.
#define ENCODE_D3D10_SB_OPERAND_DOUBLE_EXTENDED(bExtended)                     \
  (((bExtended) != 0) ? D3D10_SB_OPERAND_DOUBLE_EXTENDED_MASK : 0)
...
#define DECODE_D3D10_SB_NAME(NameToken)                                        \
...
#define DECODE_D3D10_SB_GLOBAL_FLAGS(OpcodeToken0)                             \
...
//     D3D10_SB_OPERAND_INDEX_DIMENSION_3D, and the meaning of the index
//     dimensions are as follows: (t<id>[<lbound>:<ubound>])
...
//     As opposed to when the t# is used in shader instructions, where the
//     register must be D3D10_SB_OPERAND_INDEX_DIMENSION_2D, and the meaning of
//     the index dimensions are as follows: (t<id>[<idx>]):
//       1 <id>:  variable ID being used (matches dcl)
//       2 <idx>: absolute index of resource within space (may be dynamically
//       indexed)
// (2) a Resource Return Type token (ResourceReturnTypeToken)
...
// (D3D10_SB_RESOURCE_DIMENSION enum)
#define DECODE_D3D10_SB_RESOURCE_DIMENSION(OpcodeToken0)                              \
  ((D3D10_SB_RESOURCE_DIMENSION)(((OpcodeToken0)&D3D10_SB_RESOURCE_DIMENSION_MASK) >> \
                                 D3D10_SB_RESOURCE_DIMENSION_SHIFT))

// ENCODER MACRO: Store resource dimension
// (D3D10_SB_RESOURCE_DIMENSION enum) into a
// a resource declaration token (OpcodeToken0)
#define ENCODE_D3D10_SB_RESOURCE_DIMENSION(ResourceDim)                        \
  (((ResourceDim) << D3D10_SB_RESOURCE_DIMENSION_SHIFT) &                      \
...
// use same macro for encoding/decoding resource dimension aas the non-msaa
// declaration
...
#define DECODE_D3D10_SB_RESOURCE_SAMPLE_COUNT(OpcodeToken0)                    \
  ((UINT)(((OpcodeToken0)&D3D10_SB_RESOURCE_SAMPLE_COUNT_MASK) >>              \
          D3D10_SB_RESOURCE_SAMPLE_COUNT_SHIFT))

// ENCODER MACRO: Store resource sample count up to 127 into a
// a resource declaration token (OpcodeToken0)
#define ENCODE_D3D10_SB_RESOURCE_SAMPLE_COUNT(SampleCount)                     \
  (((SampleCount > 127 ? 127 : SampleCount)                                    \
    << D3D10_SB_RESOURCE_SAMPLE_COUNT_SHIFT) &                                 \
...
#define DECODE_D3D10_SB_RESOURCE_RETURN_TYPE(ResourceReturnTypeToken,          \
                                             Component)                        \
...
//     The indexing dimension for the register must be
//     D3D10_SB_OPERAND_INDEX_DIMENSION_3D, and the meaning of the index
//     dimensions are as follows: (s<id>[<lbound>:<ubound>])
//       1 <id>:     variable ID being declared
//       2 <lbound>: the lower bound of the range of samplers in the space
//       3 <ubound>: the upper bound (inclusive) of this range
//     As opposed to when the s# is used in shader instructions, where the
//     register must be D3D10_SB_OPERAND_INDEX_DIMENSION_2D, and the meaning of
//     the index dimensions are as follows: (s<id>[<idx>]):
//       1 <id>:  variable ID being used (matches dcl)
//       2 <idx>: absolute index of sampler within space (may be dynamically
//       indexed)
...
#define DECODE_D3D10_SB_SAMPLER_MODE(OpcodeToken0)                             \
  ((D3D10_SB_SAMPLER_MODE)(((OpcodeToken0)&D3D10_SB_SAMPLER_MODE_MASK) >>      \
                           D3D10_SB_SAMPLER_MODE_SHIFT))

// ENCODER MACRO: Generate a resource return type for a component
#define ENCODE_D3D10_SB_SAMPLER_MODE(SamplerMode)                              \
...
#define DECODE_D3D10_SB_INPUT_INTERPOLATION_MODE(OpcodeToken0)                              \
  ((D3D10_SB_INTERPOLATION_MODE)(((OpcodeToken0)&D3D10_SB_INPUT_INTERPOLATION_MODE_MASK) >> \
                                 D3D10_SB_INPUT_INTERPOLATION_MODE_SHIFT))

// ENCODER MACRO: Encode interpolation mode for a register.
#define ENCODE_D3D10_SB_INPUT_INTERPOLATION_MODE(InterpolationMode)            \
...
//     which cb#[] is being declared, and the second (array) index specifies the
//     size of the buffer, as a count of 32-bit*4 elements.  (As opposed to when
//     the cb#[] is used in shader instructions, and the array index represents
//     which location in the constant buffer is being referenced.) If the size
//     is specified as 0, the CB size is not known (any size CB can be bound to
//     the slot).
//
...
//
// OpcodeToken0 is followed by 3 operands on Shader Model 5.1 and later:
// (1) Operand, starting with OperandToken0, defining which CB range (ID and
// bounds)
//     is being declared. (operand type: D3D10_SB_OPERAND_TYPE_CONSTANT_BUFFER)
//     The indexing dimension for the register must be
//     D3D10_SB_OPERAND_INDEX_DIMENSION_3D, and the meaning of the index
//     dimensions are as follows: (cb<id>[<lbound>:<ubound>])
//       1 <id>:     variable ID being declared
//       2 <lbound>: the lower bound of the range of constant buffers in the
//       space 3 <ubound>: the upper bound (inclusive) of this range
//     As opposed to when the cb#[] is used in shader instructions:
//     (cb<id>[<idx>][<loc>])
//       1 <id>:  variable ID being used (matches dcl)
//       2 <idx>: absolute index of constant buffer within space (may be
//       dynamically indexed) 3 <loc>: location of vector within constant buffer
//       being referenced,
//          which may also be dynamically indexed, with no access pattern flag
//          required.
// (2) a DWORD indicating the size of the constant buffer as a count of 16-byte
// vectors.
...
// DECODER MACRO: Find out if a Constant Buffer is going to be indexed or not
#define DECODE_D3D10_SB_CONSTANT_BUFFER_ACCESS_PATTERN(OpcodeToken0)                                          \
  ((D3D10_SB_CONSTANT_BUFFER_ACCESS_PATTERN)(((OpcodeToken0)&D3D10_SB_CONSTANT_BUFFER_ACCESS_PATTERN_MASK) >> \
                                             D3D10_SB_CONSTANT_BUFFER_ACCESS_PATTERN_SHIFT))

// ENCODER MACRO: Encode the access pattern for the Constant Buffer
#define ENCODE_D3D10_SB_D3D10_SB_CONSTANT_BUFFER_ACCESS_PATTERN(AccessPattern) \
...
// (3) D3D11_SB_SHADER_MESSAGE_FORMAT indicating the convention for formatting
// the message. (4) DWORD indicating the number of characters in the string
// without the terminator. (5) DWORD indicating the number of operands. (6)
// DWORD indicating length of operands. (7) Encoded operands. (8) String with
// trailing zero, padded to a multiple of DWORDs.
...
#define DECODE_D3D10_SB_GS_INPUT_PRIMITIVE(OpcodeToken0)                       \
  ((D3D10_SB_PRIMITIVE)(((OpcodeToken0)&D3D10_SB_GS_INPUT_PRIMITIVE_MASK) >>   \
...
#define ENCODE_D3D10_SB_GS_INPUT_PRIMITIVE(Prim)                               \
  (((Prim) << D3D10_SB_GS_INPUT_PRIMITIVE_SHIFT) &                             \
...
#define DECODE_D3D10_SB_GS_OUTPUT_PRIMITIVE_TOPOLOGY(OpcodeToken0)                              \
  ((D3D10_SB_PRIMITIVE_TOPOLOGY)(((OpcodeToken0)&D3D10_SB_GS_OUTPUT_PRIMITIVE_TOPOLOGY_MASK) >> \
                                 D3D10_SB_GS_OUTPUT_PRIMITIVE_TOPOLOGY_SHIFT))

// ENCODER MACRO: Store primitive topology
// (D3D10_SB_PRIMITIVE_TOPOLOGY enum) into a
// a primitive topology declaration token (OpcodeToken0)
#define ENCODE_D3D10_SB_GS_OUTPUT_PRIMITIVE_TOPOLOGY(PrimTopology)             \
...
#define DECODE_D3D11_SB_INPUT_CONTROL_POINT_COUNT(OpcodeToken0)                \
  ((UINT)(((OpcodeToken0)&D3D11_SB_INPUT_CONTROL_POINT_COUNT_MASK) >>          \
          D3D11_SB_INPUT_CONTROL_POINT_COUNT_SHIFT))

// ENCODER MACRO: Store input control point count into a declaration token
#define ENCODE_D3D11_SB_INPUT_CONTROL_POINT_COUNT(Count)                       \
...
// (OpcodeToken0), determine the control point count
#define DECODE_D3D11_SB_OUTPUT_CONTROL_POINT_COUNT(OpcodeToken0)               \
  ((UINT)(((OpcodeToken0)&D3D11_SB_OUTPUT_CONTROL_POINT_COUNT_MASK) >>         \
          D3D11_SB_OUTPUT_CONTROL_POINT_COUNT_SHIFT))

// ENCODER MACRO: Store output control point count into a declaration token
#define ENCODE_D3D11_SB_OUTPUT_CONTROL_POINT_COUNT(Count)                      \
...
#define DECODE_D3D11_SB_TESS_DOMAIN(OpcodeToken0)                              \
  ((D3D11_SB_TESSELLATOR_DOMAIN)(((OpcodeToken0)&D3D11_SB_TESS_DOMAIN_MASK) >> \
...
#define ENCODE_D3D11_SB_TESS_DOMAIN(Domain)                                    \
...
#define DECODE_D3D11_SB_TESS_PARTITIONING(OpcodeToken0)                                    \
  ((D3D11_SB_TESSELLATOR_PARTITIONING)(((OpcodeToken0)&D3D11_SB_TESS_PARTITIONING_MASK) >> \
...
#define ENCODE_D3D11_SB_TESS_PARTITIONING(Partitioning)                        \
  (((Partitioning) << D3D11_SB_TESS_PARTITIONING_SHIFT) &                      \
...
#define DECODE_D3D11_SB_TESS_OUTPUT_PRIMITIVE(OpcodeToken0)                                        \
  ((D3D11_SB_TESSELLATOR_OUTPUT_PRIMITIVE)(((OpcodeToken0)&D3D11_SB_TESS_OUTPUT_PRIMITIVE_MASK) >> \
...
#define ENCODE_D3D11_SB_TESS_OUTPUT_PRIMITIVE(OutputPrimitive)                 \
  (((OutputPrimitive) << D3D11_SB_TESS_OUTPUT_PRIMITIVE_SHIFT) &               \
...
// Keep PRIMITIVE_TOPOLOGY values in sync with earlier DX versions (HW consumes
// values directly).
...
// determine the return type.
#define DECODE_D3D10_SB_INSTRUCTION_RETURN_TYPE(OpcodeToken0)                                   \
  ((D3D10_SB_INSTRUCTION_RETURN_TYPE)(((OpcodeToken0)&D3D10_SB_INSTRUCTION_RETURN_TYPE_MASK) >> \
                                      D3D10_SB_INSTRUCTION_RETURN_TYPE_SHIFT))
// ENCODER MACRO: Encode the return type for instructions
// in the opcode specific control range of OpcodeToken0
#define ENCODE_D3D10_SB_INSTRUCTION_RETURN_TYPE(ReturnType)                    \
  (((ReturnType) << D3D10_SB_INSTRUCTION_RETURN_TYPE_SHIFT) &                  \
...
#define DECODE_D3D11_SB_INTERFACE_INDEXED_BIT(OpcodeToken0)                    \
  ((((OpcodeToken0)&D3D11_SB_INTERFACE_INDEXED_BIT_MASK) >>                    \
    D3D11_SB_INTERFACE_INDEXED_BIT_SHIFT)                                      \
       ? true                                                                  \
       : false)
#define ENCODE_D3D11_SB_INTERFACE_INDEXED_BIT(IndexedBit)                      \
  (((IndexedBit) << D3D11_SB_INTERFACE_INDEXED_BIT_SHIFT) &                    \
   D3D11_SB_INTERFACE_INDEXED_BIT_MASK)

// get/set the table length for an interface definition
#define DECODE_D3D11_SB_INTERFACE_TABLE_LENGTH(OpcodeToken0)                   \
  ((UINT)(((OpcodeToken0)&D3D11_SB_INTERFACE_TABLE_LENGTH_MASK) >>             \
          D3D11_SB_INTERFACE_TABLE_LENGTH_SHIFT))
#define ENCODE_D3D11_SB_INTERFACE_TABLE_LENGTH(TableLength)                    \
...
#define DECODE_D3D11_SB_INTERFACE_ARRAY_LENGTH(OpcodeToken0)                   \
  ((UINT)(((OpcodeToken0)&D3D11_SB_INTERFACE_ARRAY_LENGTH_MASK) >>             \
          D3D11_SB_INTERFACE_ARRAY_LENGTH_SHIFT))
#define ENCODE_D3D11_SB_INTERFACE_ARRAY_LENGTH(ArrayLength)                    \
...
// OpcodeToken0 is followed by 2 operands on Shader Models 4.0 through 5.0:
// (1) an operand, starting with OperandToken0, defining which
//     u# register (D3D11_SB_OPERAND_TYPE_UNORDERED_ACCESS_VIEW) is being
//     declared.
// (2) a Resource Return Type token (ResourceReturnTypeToken)
//
// OpcodeToken0 is followed by 3 operands on Shader Model 5.1 and later:
// (1) an operand, starting with OperandToken0, defining which
//     u# register (D3D11_SB_OPERAND_TYPE_UNORDERED_ACCESS_VIEW) is being
//     declared. The indexing dimension for the register must be
//     D3D10_SB_OPERAND_INDEX_DIMENSION_3D, and the meaning of the index
//     dimensions are as follows: (u<id>[<lbound>:<ubound>])
//       1 <id>:     variable ID being declared
//       2 <lbound>: the lower bound of the range of UAV's in the space
//       3 <ubound>: the upper bound (inclusive) of this range
//     As opposed to when the u# is used in shader instructions, where the
//     register must be D3D10_SB_OPERAND_INDEX_DIMENSION_2D, and the meaning of
//     the index dimensions are as follows: (u<id>[<idx>]):
//       1 <id>:  variable ID being used (matches dcl)
//       2 <idx>: absolute index of uav within space (may be dynamically
//       indexed)
// (2) a Resource Return Type token (ResourceReturnTypeToken)
// (3) a DWORD indicating the space index.
//
...
// DECODER MACRO: Retrieve flags for sync instruction from OpcodeToken0.
#define DECODE_D3D11_SB_ACCESS_COHERENCY_FLAGS(OperandToken0)                  \
  ((OperandToken0)&D3D11_SB_ACCESS_COHERENCY_MASK)

// ENCODER MACRO: Given a set of sync instruciton flags, encode them in
// OpcodeToken0.
#define ENCODE_D3D11_SB_ACCESS_COHERENCY_FLAGS(Flags)                          \
  ((Flags)&D3D11_SB_ACCESS_COHERENCY_MASK)

// Additional UAV access flags
#define D3D11_SB_RASTERIZER_ORDERED_ACCESS 0x00020000

// Resource flags mask.  Use to retrieve all resource flags, including the order
// preserving counter.
#define D3D11_SB_RESOURCE_FLAGS_MASK                                           \
...
#define DECODE_D3D11_SB_UAV_FLAGS(OperandToken0)                               \
...
// OpcodeToken0 is followed by 2 operands:
// (1) an operand, starting with OperandToken0, defining which
//     g# register (D3D11_SB_OPERAND_TYPE_THREAD_GROUP_SHARED_MEMORY) is being
//     declared.

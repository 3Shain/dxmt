...
using DeviceNotificationHandlerBlock =
    __Block<void(class Device *pDevice, DeviceNotificationName notifyName)>;
...
using NewLibraryCompletionHandler = __Block<void(class Library *, NS::Error *)>;
...
using NewRenderPipelineStateCompletionHandler =
    __Block<void(class RenderPipelineState *, NS::Error *)>;
...
using NewRenderPipelineStateWithReflectionCompletionHandler =
    __Block<void(class RenderPipelineState *, class RenderPipelineReflection *,
                 NS::Error *)>;
...
using NewComputePipelineStateCompletionHandler =
    __Block<void(class ComputePipelineState *, NS::Error *)>;
...
using NewComputePipelineStateWithReflectionCompletionHandler =
    __Block<void(class ComputePipelineState *,
...
extern "C" SYSV_ABI MTL::Device *MTLCreateSystemDefaultDevice();

extern "C" SYSV_ABI NS::Array *MTLCopyAllDevices();

extern "C" SYSV_ABI NS::Array *
MTLCopyAllDevicesWithObserver(NS::Object **,
                              MTL::DeviceNotificationHandlerBlock);

extern "C" SYSV_ABI void MTLRemoveDeviceObserver(const NS::Object *);

_MTL_INLINE MTL::Device *MTL::CreateSystemDefaultDevice() {
  return ::MTLCreateSystemDefaultDevice();
}

_MTL_INLINE NS::Array *MTL::CopyAllDevices() { return ::MTLCopyAllDevices(); }
...
_MTL_INLINE NS::Array *MTL::CopyAllDevicesWithObserver(
...
_MTL_INLINE void MTL::RemoveDeviceObserver(const NS::Object *pObserver) {
...
_MTL_INLINE MTL::ArgumentAccess MTL::ArgumentDescriptor::access() const {
  return Object::sendMessage<MTL::ArgumentAccess>(this,
                                                  _MTL_PRIVATE_SEL(access));
}

_MTL_INLINE void
MTL::ArgumentDescriptor::setAccess(MTL::ArgumentAccess access) {
...
_MTL_INLINE void MTL::Device::newLibrary(
    ...
    const NewLibraryCompletionHandlerFunction &completionHandler) {
  NewLibraryCompletionHandler block(completionHandler);
  newLibrary(pSource, pOptions, &block);
}
...
_MTL_INLINE void MTL::Device::newLibrary(
    ...
    const MTL::NewLibraryCompletionHandlerFunction &completionHandler) {
  NewLibraryCompletionHandler block(completionHandler);
  newLibrary(pDescriptor, &block);
}

_MTL_INLINE void MTL::Device::newRenderPipelineState(
    const RenderPipelineDescriptor *pDescriptor,
    const NewRenderPipelineStateCompletionHandlerFunction &completionHandler) {
  NewRenderPipelineStateCompletionHandler block(completionHandler);
  newRenderPipelineState(pDescriptor, &block);
}
...
_MTL_INLINE void MTL::Device::newRenderPipelineState(
  ...
  newRenderPipelineState(pDescriptor, options, &block);
}
...
_MTL_INLINE void MTL::Device::newComputePipelineState(
  ...
  NewComputePipelineStateCompletionHandler block(completionHandler);
  newComputePipelineState(pFunction, &block);
}
...
_MTL_INLINE void MTL::Device::newComputePipelineState(
  ...
  NewComputePipelineStateWithReflectionCompletionHandler block(
      completionHandler);
  newComputePipelineState(pFunction, options, &block);
}
...
_MTL_INLINE void MTL::Device::newComputePipelineState(
  ...
  NewComputePipelineStateWithReflectionCompletionHandler block(
      completionHandler);
  newComputePipelineState(pDescriptor, options, &block);
}

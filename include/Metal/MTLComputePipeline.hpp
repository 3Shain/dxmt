...
class ComputePipelineReflection
    : public NS::Referencing<ComputePipelineReflection> {
public:
...
class ComputePipelineDescriptor
    : public NS::Copying<ComputePipelineDescriptor> {
public:
  ...
  void setStageInputDescriptor(
      const class StageInputOutputDescriptor *stageInputDescriptor);
...
public:
  ...
  newComputePipelineState(const NS::Array *functions, NS::Error **error);
...
// static method: alloc
_MTL_INLINE MTL::ComputePipelineReflection *
MTL::ComputePipelineReflection::alloc() {
...
// method: init
_MTL_INLINE MTL::ComputePipelineReflection *
MTL::ComputePipelineReflection::init() {
...
// static method: alloc
_MTL_INLINE MTL::ComputePipelineDescriptor *
MTL::ComputePipelineDescriptor::alloc() {
...
// method: init
_MTL_INLINE MTL::ComputePipelineDescriptor *
MTL::ComputePipelineDescriptor::init() {
...
_MTL_INLINE void
MTL::ComputePipelineDescriptor::setLabel(const NS::String *label) {
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setLabel_), label);
}

// property: computeFunction
_MTL_INLINE MTL::Function *
MTL::ComputePipelineDescriptor::computeFunction() const {
  return Object::sendMessage<MTL::Function *>(
      this, _MTL_PRIVATE_SEL(computeFunction));
}

_MTL_INLINE void MTL::ComputePipelineDescriptor::setComputeFunction(
    const MTL::Function *computeFunction) {
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setComputeFunction_),
                            computeFunction);
}

// property: threadGroupSizeIsMultipleOfThreadExecutionWidth
_MTL_INLINE bool MTL::ComputePipelineDescriptor::
    threadGroupSizeIsMultipleOfThreadExecutionWidth() const {
  return Object::sendMessage<bool>(
      this, _MTL_PRIVATE_SEL(threadGroupSizeIsMultipleOfThreadExecutionWidth));
}

_MTL_INLINE void MTL::ComputePipelineDescriptor::
...
MTL::ComputePipelineDescriptor::maxTotalThreadsPerThreadgroup() const {
...
MTL::ComputePipelineDescriptor::stageInputDescriptor() const {
...
MTL::ComputePipelineDescriptor::buffers() const {
  return Object::sendMessage<MTL::PipelineBufferDescriptorArray *>(
      this, _MTL_PRIVATE_SEL(buffers));
}

// property: supportIndirectCommandBuffers
_MTL_INLINE bool
MTL::ComputePipelineDescriptor::supportIndirectCommandBuffers() const {
  return Object::sendMessageSafe<bool>(
      this, _MTL_PRIVATE_SEL(supportIndirectCommandBuffers));
}

_MTL_INLINE void
MTL::ComputePipelineDescriptor::setSupportIndirectCommandBuffers(
...
_MTL_INLINE NS::Array *MTL::ComputePipelineDescriptor::insertLibraries() const {
  return Object::sendMessage<NS::Array *>(this,
                                          _MTL_PRIVATE_SEL(insertLibraries));
}

_MTL_INLINE void MTL::ComputePipelineDescriptor::setInsertLibraries(
    const NS::Array *insertLibraries) {
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setInsertLibraries_),
                            insertLibraries);
}

// property: preloadedLibraries
_MTL_INLINE NS::Array *
MTL::ComputePipelineDescriptor::preloadedLibraries() const {
  return Object::sendMessage<NS::Array *>(this,
...
MTL::ComputePipelineDescriptor::linkedFunctions() const {
...
_MTL_INLINE bool
MTL::ComputePipelineDescriptor::supportAddingBinaryFunctions() const {
  return Object::sendMessageSafe<bool>(
      this, _MTL_PRIVATE_SEL(supportAddingBinaryFunctions));
}

_MTL_INLINE void
MTL::ComputePipelineDescriptor::setSupportAddingBinaryFunctions(
...
_MTL_INLINE NS::UInteger
MTL::ComputePipelineDescriptor::maxCallStackDepth() const {
...
// property: maxTotalThreadsPerThreadgroup
_MTL_INLINE NS::UInteger
MTL::ComputePipelineState::maxTotalThreadsPerThreadgroup() const {
  return Object::sendMessage<NS::UInteger>(
      this, _MTL_PRIVATE_SEL(maxTotalThreadsPerThreadgroup));
}
...
_MTL_INLINE NS::UInteger
MTL::ComputePipelineState::threadExecutionWidth() const {
  return Object::sendMessage<NS::UInteger>(
      this, _MTL_PRIVATE_SEL(threadExecutionWidth));
}

// property: staticThreadgroupMemoryLength
_MTL_INLINE NS::UInteger
MTL::ComputePipelineState::staticThreadgroupMemoryLength() const {
  return Object::sendMessage<NS::UInteger>(
      this, _MTL_PRIVATE_SEL(staticThreadgroupMemoryLength));
}
...
// property: supportIndirectCommandBuffers
_MTL_INLINE bool
MTL::ComputePipelineState::supportIndirectCommandBuffers() const {
  return Object::sendMessageSafe<bool>(
      this, _MTL_PRIVATE_SEL(supportIndirectCommandBuffers));
}
...
MTL::ComputePipelineState::functionHandle(const MTL::Function *function) {
...
MTL::ComputePipelineState::newComputePipelineState(const NS::Array *functions,
                                                   NS::Error **error) {

...
public:
  ...
  void setObject(
      const class ResourceStatePassSampleBufferAttachmentDescriptor *attachment,
      NS::UInteger attachmentIndex);
};

class ResourceStatePassDescriptor
    : public NS::Copying<ResourceStatePassDescriptor> {
public:
...
_MTL_INLINE void
MTL::ResourceStatePassSampleBufferAttachmentDescriptor::setSampleBuffer(
...
_MTL_INLINE void MTL::ResourceStatePassSampleBufferAttachmentDescriptor::
...
MTL::ResourceStatePassDescriptor::alloc() {
...
// method: init
_MTL_INLINE MTL::ResourceStatePassDescriptor *
MTL::ResourceStatePassDescriptor::init() {

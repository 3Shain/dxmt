...
class BlitCommandEncoder
    : public NS::Referencing<BlitCommandEncoder, CommandEncoder> {
public:
  void synchronizeResource(const class Resource *resource);

  void synchronizeTexture(const class Texture *texture, NS::UInteger slice,
                          NS::UInteger level);
  ...
  void copyFromBuffer(const class Buffer *sourceBuffer,
  ...
  void copyFromTexture(const class Texture *sourceTexture,
                       NS::UInteger sourceSlice, NS::UInteger sourceLevel,
                       MTL::Origin sourceOrigin, MTL::Size sourceSize,
                       const class Buffer *destinationBuffer,
  ...
  void getTextureAccessCounters(const class Texture *texture,
                                MTL::Region region, NS::UInteger mipLevel,
                                NS::UInteger slice, bool resetCounters,
                                const class Buffer *countersBuffer,
                                NS::UInteger countersBufferOffset);

  void resetTextureAccessCounters(const class Texture *texture,
                                  MTL::Region region, NS::UInteger mipLevel,
                                  NS::UInteger slice);
  ...
  void resetCommandsInBuffer(const class IndirectCommandBuffer *buffer,
                             NS::Range range);

  void copyIndirectCommandBuffer(const class IndirectCommandBuffer *source,
  ...
  void resolveCounters(const class CounterSampleBuffer *sampleBuffer,
                       NS::Range range, const class Buffer *destinationBuffer,
                       NS::UInteger destinationOffset);
};
...
_MTL_INLINE void
MTL::BlitCommandEncoder::synchronizeResource(const MTL::Resource *resource) {
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(synchronizeResource_),
                            resource);
}

// method: synchronizeTexture:slice:level:
_MTL_INLINE void MTL::BlitCommandEncoder::synchronizeTexture(
    const MTL::Texture *texture, NS::UInteger slice, NS::UInteger level) {
  Object::sendMessage<void>(this,
                            _MTL_PRIVATE_SEL(synchronizeTexture_slice_level_),
                            texture, slice, level);
}
...
_MTL_INLINE void MTL::BlitCommandEncoder::copyFromTexture(
    const MTL::Texture *sourceTexture, NS::UInteger sourceSlice,
  ...
  Object::sendMessage<void>(
      ...
      destinationTexture, destinationSlice, destinationLevel,
      destinationOrigin);
}
...
_MTL_INLINE void MTL::BlitCommandEncoder::copyFromBuffer(
    const MTL::Buffer *sourceBuffer, NS::UInteger sourceOffset,
  ...
  Object::sendMessage<void>(
      ...
      sourceBuffer, sourceOffset, sourceBytesPerRow, sourceBytesPerImage,
...
_MTL_INLINE void
MTL::BlitCommandEncoder::generateMipmaps(const MTL::Texture *texture) {
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(generateMipmapsForTexture_),
                            texture);
}

// method: fillBuffer:range:value:
_MTL_INLINE void MTL::BlitCommandEncoder::fillBuffer(const MTL::Buffer *buffer,
                                                     NS::Range range,
                                                     uint8_t value) {
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(fillBuffer_range_value_),
                            buffer, range, value);
}
...
_MTL_INLINE void MTL::BlitCommandEncoder::copyFromTexture(
  ...
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(copyFromTexture_toTexture_),
...
// method: waitForFence:
_MTL_INLINE void
MTL::BlitCommandEncoder::waitForFence(const MTL::Fence *fence) {
...
_MTL_INLINE void MTL::BlitCommandEncoder::getTextureAccessCounters(
    const MTL::Texture *texture, MTL::Region region, NS::UInteger mipLevel,
  ...
  Object::sendMessage<void>(
      ...
      texture, region, mipLevel, slice, resetCounters, countersBuffer,
      countersBufferOffset);
}

// method: resetTextureAccessCounters:region:mipLevel:slice:
_MTL_INLINE void MTL::BlitCommandEncoder::resetTextureAccessCounters(
    const MTL::Texture *texture, MTL::Region region, NS::UInteger mipLevel,
    NS::UInteger slice) {
  Object::sendMessage<void>(
      this, _MTL_PRIVATE_SEL(resetTextureAccessCounters_region_mipLevel_slice_),
...
_MTL_INLINE void MTL::BlitCommandEncoder::optimizeContentsForGPUAccess(
  ...
  Object::sendMessage<void>(
      this, _MTL_PRIVATE_SEL(optimizeContentsForGPUAccess_), texture);
}
...
_MTL_INLINE void MTL::BlitCommandEncoder::optimizeContentsForGPUAccess(
    const MTL::Texture *texture, NS::UInteger slice, NS::UInteger level) {
  Object::sendMessage<void>(
      this, _MTL_PRIVATE_SEL(optimizeContentsForGPUAccess_slice_level_),
      texture, slice, level);
}
...
_MTL_INLINE void MTL::BlitCommandEncoder::optimizeContentsForCPUAccess(
    const MTL::Texture *texture) {
  Object::sendMessage<void>(
      this, _MTL_PRIVATE_SEL(optimizeContentsForCPUAccess_), texture);
}
...
_MTL_INLINE void MTL::BlitCommandEncoder::optimizeContentsForCPUAccess(
    const MTL::Texture *texture, NS::UInteger slice, NS::UInteger level) {
  Object::sendMessage<void>(
      this, _MTL_PRIVATE_SEL(optimizeContentsForCPUAccess_slice_level_),
      texture, slice, level);
}
...
_MTL_INLINE void MTL::BlitCommandEncoder::resetCommandsInBuffer(
  ...
  Object::sendMessage<void>(
      this, _MTL_PRIVATE_SEL(resetCommandsInBuffer_withRange_), buffer, range);
}
...
_MTL_INLINE void MTL::BlitCommandEncoder::optimizeIndirectCommandBuffer(
  ...
  Object::sendMessage<void>(
      this, _MTL_PRIVATE_SEL(optimizeIndirectCommandBuffer_withRange_),

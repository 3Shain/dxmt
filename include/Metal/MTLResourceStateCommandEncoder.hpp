...
public:
  ...
  void moveTextureMappingsFromTexture(
      const class Texture *sourceTexture, NS::UInteger sourceSlice,
...
_MTL_INLINE void MTL::ResourceStateCommandEncoder::updateTextureMapping(
    ...
    const NS::UInteger slice) {
  Object::sendMessage<void>(
      this, _MTL_PRIVATE_SEL(updateTextureMapping_mode_region_mipLevel_slice_),
...
// method: updateFence:
_MTL_INLINE void
MTL::ResourceStateCommandEncoder::updateFence(const MTL::Fence *fence) {
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(updateFence_), fence);
}

// method: waitForFence:
_MTL_INLINE void
MTL::ResourceStateCommandEncoder::waitForFence(const MTL::Fence *fence) {
...
_MTL_INLINE void
MTL::ResourceStateCommandEncoder::moveTextureMappingsFromTexture(

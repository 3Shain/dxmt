...
using CommandBufferHandler = __Block<void(CommandBuffer *)>;
...
MTL::CommandBuffer::addScheduledHandler(const HandlerFunction &function) {
  CommandBufferHandler block(function);
...
_MTL_INLINE void MTL::CommandBuffer::addScheduledHandler(
    const MTL::CommandBufferHandler *block) {
...
_MTL_INLINE void MTL::CommandBuffer::addCompletedHandler(
    const MTL::CommandBufferHandler *block) {

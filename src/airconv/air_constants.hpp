...
// BETTER_ENUM(EIntrinsicOp, uint32_t, dot, fast_exp2, fast_log2, fast_fract,
// fma,
//             fast_fmax, fast_fmom, fast_rint, fast_floor, fast_ceil,
//             fast_round, fast_sqrt, fast_sin, fast_cos, fast_fabs,
//             reverse_bits, popcount);

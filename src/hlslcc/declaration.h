...
struct Declaration {
  Declaration()
      : eOpcode(OPCODE_INVALID), ui32NumOperands(0), ui32BufferStride(0),
        ui32TableLength(0), ui32IsShadowTex(0) {}
  ...
  struct UAV_TAG {
    UAV_TAG()
        : ui32GloballyCoherentAccess(0), bCounter(0), Type(RETURN_TYPE_UNORM),
          ui32NumComponents(0), ui32AccessFlags(0) {}
  ...
  struct TGSM_TAG {
    ...
    TGSM_TAG() : ui32Stride(0), ui32Count(0) {}
  } sTGSM;
  ...
  struct IndexableTemp_TAG {
    ...
    IndexableTemp_TAG()
        : ui32RegIndex(0), ui32RegCount(0), ui32RegComponentSize(0) {}
  } sIdxTemp;
